  ...
  const testimonials = [
    {
      name: 'Chiamaka Eze',
      score: 'JAMB 312 / 400',
      text: 'Heritage Tutorials made me feel ready on exam day. The mock CBT felt identical to the real thing!'
    },
    {
      name: 'Tunde Bakare',
      score: 'WAEC 8 A1s',
      text: 'The instant feedback and explanations are gold. I improved my Math score by 40% in 6 weeks.'
    },
    {
      name: 'Amaka Johnson',
      score: 'JAMB 289 / 400',
      text: 'Clean interface, no distractions, and the analytics helped me focus on my weak areas.'
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-b p-4">
            <div className="flex flex-col gap-4">
              ...
              <Link to="/dashboard" onClick={() => setIsMenuOpen(false)}><Button className="w-full">Start Practice</Button></Link>
            </div>
          </div>
        )}
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100 text-emerald-700 text-sm font-medium">
                ...
                Trusted by 25,000+ Nigerian students
              </div>
              <h1 className="text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight">
                Practice JAMB & WAEC <br/>
                <span className="text-[#059669]">CBT Exams Online</span>
              </h1>
              <p className="text-xl text-gray-600 max-w-lg">
                The most realistic CBT practice platform in Nigeria. Take mock exams, review detailed answers, and track your progress — all in one premium dashboard.
              </p>
              ...
              <div className="relative bg-white p-6 rounded-2xl shadow-2xl border border-gray-100">
                 <div className="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-100">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5">
                      <div className="bg-[#059669] h-2.5 rounded-full w-[87%]"></div>
                    </div>
                    <p className="text-sm text-gray-500 mt-2">Score: 87% · Top 10%</p>
                 </div>
                 <div className="space-y-3">
                   {['A', 'B', 'C', 'D'].map((opt, i) => (
                     <div key={opt} className={`p-3 rounded-lg border ${i === 1 ? 'border-[#059669] bg-emerald-50' : 'border-gray-200'}`}>
                       Option {opt}
                     </div>
                   )}
                 </div>
              ...
              <div className="absolute top-10 -left-10 bg-white p-4 rounded-xl shadow-lg border border-gray-100 animate-bounce">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="font-bold">1,247 students online</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="features" className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Everything you need to ace your CBT</h2>
            <p className="text-xl text-gray-600">Powerful tools built specifically for JAMB & WAEC candidates.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, i) => (
              <div key={i} className="p-6 rounded-2xl border border-gray-100 hover:border-emerald-100 hover:shadow-lg hover:shadow-emerald-50/50 transition-all">
                <div className="w-12 h-12 bg-emerald-100 text-[#059669] rounded-xl flex items-center justify-center mb-4">
      ...
      <section id="subjects" className="py-24 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Covering every JAMB & WAEC subject</h2>
          </div>
            ...
            {subjects.map((sub, i) => (
              <div key={i} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-500 text-sm">{sub.count}</p>
                </div>
      ...
      <section id="testimonials" className="py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Students love Heritage Tutorials</h2>
          </div>
              ...
              <div key={i} className="p-8 rounded-2xl border border-gray-100 bg-white">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#059669] font-medium">{t.score}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      {/* CTA */}
      <section className="py-20 px-4 bg-[#059669]">
        <div className="max-w-4xl mx-auto text-center text-white">
          <h2 className="text-4xl font-bold mb-6">Ready to pass with flying colours?</h2>
          <p className="text-xl mb-8 text-emerald-100">Join thousands of Nigerian students already excelling with Heritage Tutorials.</p>
          <Link to="/dashboard">
            <Button size="lg" className="bg-white text-[#059669] hover:bg-emerald-50">
              Start Free Practice
            </Button>
          </Link>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
           <div className="col-span-1 md:col-span-2">
             <div className="flex items-center gap-2 mb-4">
                <div className="h-8 w-8 bg-[#059669] rounded-lg flex items-center justify-center text-white font-bold text-xl">H</div>
                <span className="text-xl font-bold text-white">HERITAGETUTORIALS</span>
             </div>
             <p className="text-gray-400">Nigeria's premium CBT practice platform helping students excel at JAMB & WAEC.</p>
           </div>
           <div>
             <h4 className="text-white font-bold mb-4">Contact</h4>
             <ul className="space-y-2">
               <li>12 Awolowo Way, Ikeja, Lagos</li>
               <li>hello@heritagetutorials.ng</li>
