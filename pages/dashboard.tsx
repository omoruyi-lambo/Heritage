...
import { SUBJECTS } from '../src/data/store'
    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      <aside className="w-64 bg-white border-r border-gray-200 flex flex-col hidden md:flex">
        ...
        <nav className="flex-1 px-4 space-y-2">
          <Link href="/dashboard" className="flex items-center gap-3 px-4 py-3 text-gray-700 bg-gray-50 rounded-lg font-medium">
          ...
          <Link href="/results" className="flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 rounded-lg w-full text-left">
        ...
        <div className="p-8 max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <Link href="/results" className="block text-center text-[#059669] font-medium pt-2 hover:underline">
                  View All Results
                </Link>
              </div>
            </div>
          ...
          <div>
            <div className="flex justify-between items-center mb-6">
              ...
              <Link href="/" className="text-[#059669] hover:underline font-medium">View all</Link>
            </div>
